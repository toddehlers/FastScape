      subroutine Mad_He (time,temperature,ntime,Apatite_age,iflag,size)
...
! iflag=6 Ar in Hornblende
      ...
      real size,Apatite_age

      if (iflag.eq.1) then
! He in Ap
!      D0a2=5.e5*3600.*24.*365.25e6
      D0a2=0.0032/size**2*3600.*24.*365.25e6
      Ea=138.e3
...
!                               1 = cylindrical
      ...
      Da2now=D0a2*exp(-Ea/R/(temps+273.))
        ...
        call tridag_real (inf,diag,sup,f,age,n)
